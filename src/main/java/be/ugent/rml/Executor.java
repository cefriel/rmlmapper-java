...
public class Executor implements Mapper {
    ...
    public Executor(Initializer initializer, RecordsFactory recordsFactory, QuadStore resultingQuads, String baseIRI) throws Exception {
